...
const Projects = () => {
  return (
    <div className="min-h-[calc(100svh-80px)] w-full flex items-center justify-center pt-16 mb-32 lg:px-14 px-4 ">
      <div className="w-full h-full max-w-[1600px] flex flex-col  items-center lg:items-start justify-center gap-10">
